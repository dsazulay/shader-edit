...
{
    createGraphicsPipeline(configInfo, vertCode, fragCode);
}
...
auto Pipeline::createGraphicsPipeline(const PipelineConfigInfo& configInfo, std::vector<char>& vertCode, std::vector<char>& fragCode) -> void
{
    ...
    shaderStageInfo[0].module = m_vertShaderModule;
    ...
    shaderStageInfo[1].module = m_fragShaderModule;
